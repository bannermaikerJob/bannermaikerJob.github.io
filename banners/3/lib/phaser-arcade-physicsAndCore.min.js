...
function Events(){}function EE(t,e,s){this.fn=t,this.context=e,this.once=s||!1}function EventEmitter(){this._events=new Events,this._eventsCount=0}var mygame;!function(t){var e=function(){function t(){}return t.init=function(t,e,s){this.showDebugHeader(null==s?1:s),this.globalEvents=new EventEmitter,this.defaultWidth=t,this.defaultHeight=e,this.centerX=.5*t,this.centerY=.5*e},t.begin=function(t,e){this.game=t,this.game.input.maxPointers=1,this.game.stage.disableVisibilityChange=!0,this.game.scale.scaleMode=Phaser.ScaleManager.USER_SCALE,this.game.scale.pageAlignHorizontally=!0,this.game.scale.pageAlignVertically=!0;this.game.input.touch.preventDefault=!1,1==e&&(this.game.device.desktop?this.game.input.mouse.enabled=!0:this.game.input.mouse.enabled=!1),window.addEventListener("resize",this.checkScreenStatus.bind(this),!1),this.game.scale.onOrientationChange.add(this.checkScreenStatus,this),this.checkScreenStatus()},t.checkScreenStatus=function(){this._fullWidth==t.getInnerWidth()&&this._fullHeight==t.getInnerHeight()||(this.changeScale(this.game),this.globalEvents.emit("changeOrientationAndResize"))},t.changeScale=function(e){this._fullWidth=this.width=t.getInnerWidth(),this._fullHeight=this.height=t.getInnerHeight();var s=this.width,i=this.height;this.isLandscape!=this.isDefaultLandscape&&(s=this.height,i=this.width);var n=1;n=Math.min(s/this.defaultWidth,i/this.defaultHeight),this.bgModeScale=Math.max(this.width/this.defaultWidth,this.height/this.defaultHeight)/n,this.width/=n,this.height/=n,e.scale.setUserScale(n,n,0,0),e.scale.setGameSize(this.width,this.height),e.world.setBounds(0,0,this.width,this.height),e.scale.refresh()},t.getInnerWidth=function(){try{return window.customClientWidth()}catch(t){return window.innerWidth}},t.getInnerHeight=function(){try{return window.customClienHeight()}catch(t){return window.innerHeight}},t.showDebugHeader=function(t){var e;switch(t){case 0:return;case 1:e="o.selyukov@gmail.com";break;case 2:e="                    "}if(navigator.userAgent.search(/Chrome/)>-1){var s=["%c     Olphabet Core v"+this.VERSION+" | "+e+"   ","color: #ffffff; background: #757B96"];console.log.apply(console,s)}else console.log("Olphabet Core v"+this.VERSION+" | "+e)},Object.defineProperty(t,"isDesktop",{get:function(){return this.game.device.desktop},enumerable:!0,configurable:!0}),Object.defineProperty(t,"isLandscape",{get:function(){return this.height<this.width},enumerable:!0,configurable:!0}),Object.defineProperty(t,"isDefaultLandscape",{get:function(){return this.defaultHeight<this.defaultWidth},enumerable:!0,configurable:!0}),t}();e.VERSION=.31,e.bgModeScale=1,t.Core=e}(mygame||(mygame={}));var __extends=this&&this.__extends||function(){var t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var s in e)e.hasOwnProperty(s)&&(t[s]=e[s])};return function(e,s){function i(){this.constructor=e}t(e,s),e.prototype=null===s?Object.create(s):(i.prototype=s.prototype,new i)}}(),mygame;!function(t){var e=function(e){function s(s,i,n){void 0===n&&(n=null);var r=this,o=null,a=null,h=null;return i.length>0&&(o=i[0],i.length>1?(a=i[1],h=i.length>2?i[2]:i[0]):(a=i[0],h=i[0])),r=e.call(this,t.Core.game,0,0,s,null,null,a,o,h,null)||this,r._framesString=[o,a,h],r.soundOver="over",r.soundDown="click",r.anchor.setTo(.5),r._cb=n,r._deltaScale=.1,r._defaultScale=1,r._isDown=!1,r._isOver=!1,r.onInputOver.add(r.over,r),r.onInputOut.add(r.out,r),r.onInputDown.add(r.down,r),r.onInputUp.add(r.up,r),r}return __extends(s,e),s.prototype.setCBContext=function(t){this._cntxt=t},s.prototype.setAnimationScale=function(t,e){void 0===t&&(t=0),void 0===e&&(e=1),this._deltaScale=t,this._defaultScale=e},s.prototype.over=function(){this._isDown||this.scale.set(this._defaultScale+this._deltaScale),this._isOver=!0},s.prototype.out=function(){this._isDown||this.scale.set(this._defaultScale),this._isOver=!1},s.prototype.up=function(){var t=this;if(this._isDown){this.scale.set(this._isOver?this._defaultScale+this._deltaScale:this._defaultScale);var e=this.game.device.desktop?this._isOver:this.input.pointerOver();this._isOver?this.frameName=this._framesString[1]:e&&setTimeout(function(){t.frameName=t._framesString[0]},5),this._isDown=!1,e&&null!=this._cb?(this._cntxt?this._cb.bind(this._cntxt)():this._cb(),this.frameName=this._framesString[0]):0==e&&this.scale.set(this._defaultScale)}},s.prototype.down=function(){this._isDown||(this.scale.set(this._defaultScale-this._deltaScale),this._isDown=!0)},s.prototype.deleteFromParent=function(){this.parent&&this.parent.removeChild(this),this.onInputOver.remove(this.over,this),this.onInputOut.remove(this.out,this),this.onInputDown.remove(this.down,this),this.onInputUp.remove(this.up,this)},Object.defineProperty(s.prototype,"enabled",{set:function(t){var e=this;this.inputEnabled=t,t||setTimeout(function(){e.frameName=e._framesString[0],e.scale.set(e._defaultScale)},5)},enumerable:!0,configurable:!0}),s}(Phaser.Button);t.OButton=e}(mygame||(mygame={}));var __extends=this&&this.__extends||function(){var t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var s in e)e.hasOwnProperty(s)&&(t[s]=e[s])};return function(e,s){function i(){this.constructor=e}t(e,s),e.prototype=null===s?Object.create(s):(i.prototype=s.prototype,new i)}}(),mygame;!function(t){var e=function(e){function s(s,i,n,r){void 0===r&&(r=null);var o=this,a=null,h=null,c=null,l=null,f=null,p=null;return i.length>0&&(a=i[0],i.length>1?(h=i[1],c=i.length>2?i[2]:i[0]):(h=i[0],c=i[0])),n.length>0&&(l=n[0],n.length>1?(f=n[1],p=n.length>2?n[2]:n[0]):(f=n[0],p=n[0])),o=e.call(this,t.Core.game,0,0,s,null,null,h,a,c,null)||this,o._framesString=[a,h,c,l,f,p],o._check=!0,o.soundOver="over",o.soundDown="click",o.anchor.setTo(.5),o._cb=r,o._deltaScale=.1,o._defaultScale=1,o._isDown=!1,o._isOver=!1,o.onInputOver.add(o.over,o),o.onInputOut.add(o.out,o),o.onInputDown.add(o.down,o),o.onInputUp.add(o.up,o),o}return __extends(s,e),s.prototype.setCheck=function(t){if(this._check!=t){this._check=t;var e=0;t||(e=3),this.setFrames(this._framesString[e+1],this._framesString[e],this._framesString[e+2],this._framesString[e])}},Object.defineProperty(s.prototype,"check",{get:function(){return this._check},enumerable:!0,configurable:!0}),s.prototype.setCBContext=function(t){this._cntxt=t},s.prototype.setAnimationScale=function(t,e){void 0===t&&(t=0),void 0===e&&(e=1),this._deltaScale=t,this._defaultScale=e},s.prototype.over=function(){this._isDown||this.scale.set(this._defaultScale+this._deltaScale),this._isOver=!0,console.log("OVER")},s.prototype.out=function(){this._isDown||this.scale.set(this._defaultScale),this._isOver=!1},s.prototype.up=function(){var t=this;if(this._isDown){this.scale.set(this._isOver?this._defaultScale+this._deltaScale:this._defaultScale);var e=this.game.device.desktop?this._isOver:this.input.pointerOver();this._isOver?this.frameName=this._framesString[1+(this._check?0:3)]:e&&setTimeout(function(){t.frameName=t._framesString[t._check?0:3]},5),this._isDown=!1,e&&null!=this._cb?(this.setCheck(!this.check),this._cntxt?this._cb.bind(this._cntxt)():this._cb(),this.frameName=this._framesString[this._check?0:3]):0==e&&this.scale.set(this._defaultScale)}},s.prototype.down=function(){this._isDown||(this.scale.set(this._defaultScale-this._deltaScale),this._isDown=!0)},s.prototype.deleteFromParent=function(){this.parent&&this.parent.removeChild(this),this.onInputOver.remove(this.over,this),this.onInputOut.remove(this.out,this),this.onInputDown.remove(this.down,this),this.onInputUp.remove(this.up,this)},Object.defineProperty(s.prototype,"enabled",{set:function(t){var e=this;this.inputEnabled=t,t||setTimeout(function(){e.frameName=e._framesString[e._check?0:3],e.scale.set(e._defaultScale)},5)},enumerable:!0,configurable:!0}),s}(Phaser.Button);t.OButtonCheck=e}(mygame||(mygame={}));var __extends=this&&this.__extends||function(){var t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var s in e)e.hasOwnProperty(s)&&(t[s]=e[s])};return function(e,s){function i(){this.constructor=e}t(e,s),e.prototype=null===s?Object.create(s):(i.prototype=s.prototype,new i)}}(),mygame;!function(t){var e=function(e){function s(s,i,n,r){void 0===s&&(s=0),void 0===i&&(i=0);var o=e.call(this,t.Core.game,0,0,n,r)||this;return o.anchor.set(.5),o.game.world.addChild(o),o._landscapeScaleX=1,o._portretScaleX=1,o._landscapeScaleY=1,o._portretScaleY=1,o._bgMode=!1,o._testMaskMode=!1,o._landscapeVisible=!0,o._portretVisible=!0,o._screenScreenCompress=!1,o._customMask=null,t.Core.isDefaultLandscape?(o._landscapeX=s/t.Core.defaultWidth,o._landscapeY=i/t.Core.defaultHeight,o._portretX=o._landscapeX,o._portretY=o._landscapeY):(o._portretX=s/t.Core.defaultWidth,o._portretY=i/t.Core.defaultHeight,o._landscapeX=o._portretX,o._landscapeY=o._portretY),o._landscapeLeftOffset=null,o._portretLeftOffset=null,o._landscapeTopOffset=null,o._portretTopOffset=null,o._landscapeRightffset=null,o._portretRightOffset=null,o._landscapeBottomOffset=null,o._portretBottomOffset=null,o.changeOrientation(),t.Core.globalEvents.on("changeOrientationAndResize",o.changeOrientation.bind(o),!1),o}return __extends(s,e),s.prototype.add=function(t){this.addChild(t)},s.prototype.otherXY=function(e,s){return t.Core.isDefaultLandscape?(this._portretX=e/t.Core.defaultHeight,this._portretY=s/t.Core.defaultWidth):(this._landscapeX=e/t.Core.defaultHeight,this._landscapeY=s/t.Core.defaultWidth),this},s.prototype.myLeftOffset=function(e){return t.Core.isDefaultLandscape?this._landscapeLeftOffset=e:this._portretLeftOffset=e,this},s.prototype.otherLeftOffset=function(e){return t.Core.isDefaultLandscape?this._portretLeftOffset=e:this._landscapeLeftOffset=e,this},s.prototype.myRightOffset=function(e){return t.Core.isDefaultLandscape?this._landscapeRightffset=e:this._portretRightOffset=e,this},s.prototype.otherRightOffset=function(e){return t.Core.isDefaultLandscape?this._portretRightOffset=e:this._landscapeRightffset=e,this},s.prototype.myTopOffset=function(e){return t.Core.isDefaultLandscape?this._landscapeTopOffset=e:this._portretTopOffset=e,this},s.prototype.otherTopOffset=function(e){return t.Core.isDefaultLandscape?this._portretTopOffset=e:this._landscapeTopOffset=e,this},s.prototype.myBottomOffset=function(e){return t.Core.isDefaultLandscape?this._landscapeBottomOffset=e:this._portretBottomOffset=e,this},s.prototype.otherBottomOffset=function(e){return t.Core.isDefaultLandscape?this._portretBottomOffset=e:this._landscapeBottomOffset=e,this},s.prototype.end=function(){return this.changeOrientation(),this},s.prototype.myScale=function(e,s){return t.Core.isDefaultLandscape?(this._landscapeScaleX=e,this._landscapeScaleY=s||e):(this._portretScaleX=e,this._portretScaleY=s||e),this},s.prototype.otherScale=function(e,s){return t.Core.isDefaultLandscape?(this._portretScaleX=e,this._portretScaleY=s||e):(this._landscapeScaleX=e,this._landscapeScaleY=s||e),this},Object.defineProperty(s.prototype,"currentScale",{get:function(){return t.Core.isLandscape?{x:this._landscapeScaleX,y:this._landscapeScaleY}:{x:this._portretScaleX,y:this._portretScaleY}},enumerable:!0,configurable:!0}),s.prototype.myVisible=function(e){return t.Core.isDefaultLandscape?this._landscapeVisible=e:this._portretVisible=e,this},s.prototype.otherVisible=function(e){return t.Core.isDefaultLandscape?this._portretVisible=e:this._landscapeVisible=e,this},s.prototype.enabledBgMode=function(){return this._bgMode=!0,this},s.prototype.enabledMask=function(e,s,i,n,r){this._customMask=new Phaser.Graphics(this.game,0,0),this._customMask.beginFill(16711680,.5);var o=i||t.Core.defaultWidth,a=n||t.Core.defaultHeight;return this._customMask.drawRect(.5*-o+(e||0),.5*-a+(s||0),o,a),this._customMask.endFill(),1!=r?(this.mask=this._customMask,this.addChild(this._customMask)):(this._testMaskMode=!0,this._customMask.x=this.x,this._customMask.y=this.y,this.game.world.addChild(this._customMask)),this},s.prototype.changeOrientation=function(){var e=1,s=1;this._bgMode&&(e=s=t.Core.bgModeScale),t.Core.isLandscape?(this.x=t.Core.width*this._landscapeX,this.y=t.Core.height*this._landscapeY,this.visible=this._landscapeVisible,e*=this._landscapeScaleX,s*=this._landscapeScaleY,this.applyLandscapeOffsets()):(this.x=t.Core.width*this._portretX,this.y=t.Core.height*this._portretY,this.visible=this._portretVisible,e*=this._portretScaleX,s*=this._portretScaleY,this.applyPortretOffsets()),this._screenScreenCompress&&(e=s=Math.min(t.Core.width/t.Core.defaultWidth,t.Core.height/t.Core.defaultHeight)),this.scale.set(e,s),this._testMaskMode&&(this._customMask.x=this.x,this._customMask.y=this.y)},s.prototype.applyLandscapeOffsets=function(){null!=this._landscapeLeftOffset&&(this.x=this._landscapeLeftOffset),null!=this._landscapeRightffset&&(this.x=t.Core.width-this._landscapeRightffset),null!=this._landscapeTopOffset&&(this.y=this._landscapeTopOffset),null!=this._landscapeBottomOffset&&(this.y=t.Core.height-this._landscapeBottomOffset)},s.prototype.applyPortretOffsets=function(){null!=this._portretLeftOffset&&(this.x=this._portretLeftOffset),null!=this._portretRightOffset&&(this.x=t.Core.width-this._portretRightOffset),null!=this._portretTopOffset&&(this.y=this._portretTopOffset),null!=this._portretBottomOffset&&(this.y=t.Core.height-this._portretBottomOffset)},s}(Phaser.Sprite);t.OSprite=e}(mygame||(mygame={}));var __extends=this&&this.__extends||function(){var t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var s in e)e.hasOwnProperty(s)&&(t[s]=e[s])};return function(e,s){function i(){this.constructor=e}t(e,s),e.prototype=null===s?Object.create(s):(i.prototype=s.prototype,new i)}}(),mygame;!function(t){var e=function(e){function s(s){void 0===s&&(s=!1);var i=e.call(this)||this;return s&&(t.Core.globalEvents.on("changeOrientationAndResize",i.changeOrientation.bind(i),!1),i.changeOrientation()),i}return __extends(s,e),s.prototype.changeOrientation=function(){t.Core.isLandscape?this.onLandscape():this.onPortret()},s.prototype.onPortret=function(){},s.prototype.onLandscape=function(){},s}(Phaser.State);t.OState=e}(mygame||(mygame={}));var has=Object.prototype.hasOwnProperty,prefix="~";Object.create&&(Events.prototype=Object.create(null),(new Events).__proto__||(prefix=!1)),EventEmitter.prototype.eventNames=function(){var t,e,s=[];if(0===this._eventsCount)return s;for(e in t=this._events)has.call(t,e)&&s.push(prefix?e.slice(1):e);return Object.getOwnPropertySymbols?s.concat(Object.getOwnPropertySymbols(t)):s},EventEmitter.prototype.listeners=function(t,e){var s=this._events[prefix?prefix+t:t];if(e)return!!s;if(!s)return[];if(s.fn)return[s.fn];for(var i=0,n=s.length,r=Array(n);i<n;i++)r[i]=s[i].fn;return r},EventEmitter.prototype.emit=function(t,e,s,i,n,r){h=prefix?prefix+t:t;if(!this._events[h])return!1;var o,a,h=this._events[h],c=arguments.length;if(h.fn){switch(h.once&&this.removeListener(t,h.fn,void 0,!0),c){case 1:return h.fn.call(h.context),!0;case 2:return h.fn.call(h.context,e),!0;case 3:return h.fn.call(h.context,e,s),!0;case 4:return h.fn.call(h.context,e,s,i),!0;case 5:return h.fn.call(h.context,e,s,i,n),!0;case 6:return h.fn.call(h.context,e,s,i,n,r),!0}for(a=1,o=Array(c-1);a<c;a++)o[a-1]=arguments[a];h.fn.apply(h.context,o)}else{var l,f=h.length;for(a=0;a<f;a++)switch(h[a].once&&this.removeListener(t,h[a].fn,void 0,!0),c){case 1:h[a].fn.call(h[a].context);break;case 2:h[a].fn.call(h[a].context,e);break;case 3:h[a].fn.call(h[a].context,e,s);break;case 4:h[a].fn.call(h[a].context,e,s,i);break;default:if(!o)for(l=1,o=Array(c-1);l<c;l++)o[l-1]=arguments[l];h[a].fn.apply(h[a].context,o)}}return!0},EventEmitter.prototype.on=function(t,e,s){return e=new EE(e,s||this),t=prefix?prefix+t:t,this._events[t]?this._events[t].fn?this._events[t]=[this._events[t],e]:this._events[t].push(e):(this._events[t]=e,this._eventsCount++),this},EventEmitter.prototype.once=function(t,e,s){return e=new EE(e,s||this,!0),t=prefix?prefix+t:t,this._events[t]?this._events[t].fn?this._events[t]=[this._events[t],e]:this._events[t].push(e):(this._events[t]=e,this._eventsCount++),this},EventEmitter.prototype.removeListener=function(t,e,s,i){if(t=prefix?prefix+t:t,!this._events[t])return this;if(!e)return 0==--this._eventsCount?this._events=new Events:delete this._events[t],this;var n=this._events[t];if(n.fn)n.fn!==e||i&&!n.once||s&&n.context!==s||(0==--this._eventsCount?this._events=new Events:delete this._events[t]);else{for(var r=0,o=[],a=n.length;r<a;r++)(n[r].fn!==e||i&&!n[r].once||s&&n[r].context!==s)&&o.push(n[r]);o.length?this._events[t]=1===o.length?o[0]:o:0==--this._eventsCount?this._events=new Events:delete this._events[t]}return this},EventEmitter.prototype.removeAllListeners=function(t){return t?(t=prefix?prefix+t:t,this._events[t]&&(0==--this._eventsCount?this._events=new Events:delete this._events[t])):(this._events=new Events,this._eventsCount=0),this},EventEmitter.prototype.off=EventEmitter.prototype.removeListener,EventEmitter.prototype.addListener=EventEmitter.prototype.on,EventEmitter.prototype.setMaxListeners=function(){return this},EventEmitter.prefixed=prefix,EventEmitter.EventEmitter=EventEmitter,"undefined"!=typeof module&&(module.exports=EventEmitter);